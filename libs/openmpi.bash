...
#add_package http://www.open-mpi.org/software/ompi/v1.8/downloads/openmpi-1.8.tar.bz2
add_package http://www.open-mpi.org/software/ompi/v1.6/downloads/openmpi-1.6.5.tar.bz2
