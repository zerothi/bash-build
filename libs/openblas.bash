...
pack_set --command "ln -s libopenblas_[^o]*p-r$(pack_get --version).a libopenblasp.a"
pack_set --command "ln -s libopenblas_[^o]*p-r$(pack_get --version).so libopenblasp.so"
pack_set --command "ln -s libopenblas_[^o]*p-r$(pack_get --version).so libopenblasp.so.0"
