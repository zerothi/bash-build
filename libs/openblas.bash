...
pack_set --command "ln -s libopenblas_[^o]*p-r*.a libopenblasp.a"
pack_set --command "ln -s libopenblas_[^o]*p-r*.so libopenblasp.so"
pack_set --command "ln -s libopenblas_[^o]*p-r*.so libopenblasp.so.0"
