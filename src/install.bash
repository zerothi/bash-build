...
function pack_install {
	...
	if $(has_setting $NO_PIC $idx) ; then
	    export FCFLAGS="$(trim_spaces ${FCFLAGS//-fPIC/})"
	    export FFLAGS="$(trim_spaces ${FFLAGS//-fPIC/})"
	    export CFLAGS="$(trim_spaces ${CFLAGS//-fPIC/})"
	    export CXXFLAGS="$(trim_spaces ${CXXFLAGS//-fPIC/})"
	    export LDFLAGS="$(trim_spaces ${LDFLAGS//-fPIC/}) $tmp_ld"
	    export CPPFLAGS="$(trim_spaces ${CPPFLAGS//-fPIC/}) $tmp_inc"
	else
	    export FCFLAGS="$(trim_spaces $FCFLAGS)"
	    export FFLAGS="$(trim_spaces $FFLAGS)"
	    export CFLAGS="$(trim_spaces $CFLAGS)"
	    export CXXFLAGS="$(trim_spaces $CXXFLAGS)"
