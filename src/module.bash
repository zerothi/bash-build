...
#	    done
#    fi
    # cmake looks in CMAKE_PREFIX_PATH/share/*
    ...
    "$(module_fmt_routine -prepend-path PYTHONPATH $fpath/lib/python)"
      for PV in 2.7 3.9 3.10 3.11 3.12 3.13 3.14 3.15 3.16 3.17 3.18 3.19 3.20 3.21 ; do
