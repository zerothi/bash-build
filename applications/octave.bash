...
pack_set --install-query $(pack_get --install-prefix)/bin/octave

tmp_flags="--with-x"
pack_set --module-requirement arpack-ng
tmp_flags="$tmp_flags --with-arpack-libdir=$(pack_get --library-path arpack-ng)"
tmp_flags="$tmp_flags --with-arpack-includedir=$(pack_get --install-prefix arpack-ng)/include"
pack_set --module-requirement fftw-3
tmp_flags="$tmp_flags --with-fftw3-libdir=$(pack_get --library-path fftw-3)"
tmp_flags="$tmp_flags --with-fftw3-includedir=$(pack_get --install-prefix fftw-3)/include"
tmp_flags="$tmp_flags --with-fftw3f-libdir=$(pack_get --library-path fftw-3)"
tmp_flags="$tmp_flags --with-fftw3f-includedir=$(pack_get --install-prefix fftw-3)/include"
pack_set --module-requirement hdf5-serial
tmp_flags="$tmp_flags --with-z-libdir=$(pack_get --library-path zlib)"
tmp_flags="$tmp_flags --with-z-includedir=$(pack_get --install-prefix zlib)/include"
tmp_flags="$tmp_flags --with-hdf5-libdir=$(pack_get --library-path hdf5-serial)"
tmp_flags="$tmp_flags --with-hdf5-includedir=$(pack_get --install-prefix hdf5-serial)/include"
...
for m in amd camd colamd ccolamd cholmod umfpack ; do
    ...
    tmp_flags="$tmp_flags --with-$m-includedir=$(pack_get --install-prefix $m)/include"
done
