...
pack_set -build-mod-req cython -build-mod-req meson -build-mod-req pythran
pack_set $(list -prefix ' -module-requirement ' dask networkx scipy pywavelets matplotlib imageio)
