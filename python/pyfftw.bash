...
pack_cmd "HAVE_SINGLE=1 HAVE_DOUBLE=1 PYFFTW_IGNORE_LONG=TRUE HAVE_OMP=1 PYFFTW_INCLUDE=$(pack_get -prefix fftw)/include PYFFTW_LIB_DIR=$(pack_get -prefix fftw)/lib $_pip_cmd . --prefix=$(pack_get -prefix)"
