...
tmp_flags="$tmp_flags -DPYTHON_LIBRARY=$(pack_get -LD $(get_parent))/libpython${pV}m.a -DPYTHON_INCLUDE_DIR=$(pack_get -prefix $(get_parent))/include/python${pV}m -DPYTHON_EXECUTABLE=$(get_parent_exec)"
